...
// Evaluator compiles and caches CEL expressions with a single typed context
...
// New creates an Evaluator with context variable declarations
...
// Compile compiles and caches an expression
...
// EvalBool evaluates an expression and returns a bool
// context — map with keys "steps", "env", "run"
...
// MustEvalBool evaluates without error (fail-open: if CEL breaks — execute the step)
