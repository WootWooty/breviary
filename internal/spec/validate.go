// YAML + JSON Schema валидация
// На входе: YAML-файл. Выход: модель Runbook или ошибка с позицией.
...
// ValidateYAML читает YAML, валидирует JSON Schema, возвращает модель
...
// Validate валидирует сырой YAML и возвращает модель
func Validate(data []byte) (*Runbook, error) {
	...
	// 2. Конвертим YAML → JSON для валидации
...
// embeddedSchema возвращает JSON Schema, встроенную в Go-бинарник
